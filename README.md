# <span style="color:#ffcb05">P</span><span style="color:#3b4cca">okemon </span><span style="color:#ff0000">L</span><span style="color:#3b4cca">evel-</span><span style="color:#2a9d3f">U</span><span style="color:#3b4cca">p!</span>
## <img src="media/logo.png" height="20" alt="PLU logo"> <span style="color:#8B1538">R</span><span style="color:#8B1538">G</span><span style="color:#8B1538">X</span> <span style="color:#4ecdc4">Mods</span> <span style="color:#3598db">-</span> [<span style="color:#8B1538">R</span><span style="color:#7598b6">ealm</span><span style="color:#8B1538">G</span><span style="color:#8B1538">X</span>](https://realmgx.com) <span style="color:#ffcb05">Community Project</span>
...
[![Wago](https://img.shields.io/badge/Wago.io-Downloads-purple?style=flat-square&logo=wago)](https://addons.wago.io/addons/pokemonlevelup)
[![WoWInterface](https://img.shields.io/badge/WoWInterface-Downloads-blue?style=flat-square&logo=worldofwarcraft)](https://www.wowinterface.com/downloads/info26261)
...
4. **<span style="color:#ff6b6b">Enable</span>** <span style="color:#ffcb05">PLU</span> <span style="color:#e67e23">in your AddOns menu</span>
5. **<span style="color:#ffcb05">Type</span>** `/plu help` <span style="color:#e67e23">to see all commands and start leveling!</span>
...
| Command | Description |
|---------|-------------|
| `/plu help` | Show all available commands |
| `/plu test` | Play test sound |
| `/plu enable` | Enable addon |
| `/plu disable` | Disable addon (unmutes default sound) |
| `/plu welcome` | Toggle login welcome message |
| `/plu high` | Use high quality sound |
| `/plu med` | Use medium quality sound (default) |
| `/plu low` | Use low quality sound |
...
3. **<span style="color:#b96ad9">Restart</span>** <span style="color:#06c">WoW</span> <span style="color:#e67e23">and enable</span> <span style="color:#ffcb05">PLU</span> <span style="color:#e67e23">in AddOns menu</span>
...
**<span style="color:#2dc26b">The Kiwi Says:</span>** <span style="color:#b96ad9">"Gotta ding 'em all. Bwwiiiee."</span>
